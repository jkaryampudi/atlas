...
do shell script "lsof -ti :8001 | xargs kill 2>/dev/null ; sleep 1 ; cd /Users/jayakrishnakaryampudi/atlas && set -a && . ./.env 2>/dev/null ; set +a ; (nohup env ATLAS_INPROC_SCHEDULER=1 ./.venv/bin/uvicorn atlas.api.main:app --port 8001 >> /tmp/atlas-api.log 2>&1 &) ; sleep 2"
